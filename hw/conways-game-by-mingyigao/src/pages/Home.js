...
function HomePage() {
  return (
    <>
      ...
      <Link to="/game" className={classes.linkButton}>
        Let's play the game!
      </Link>
      <div class={classes.content}>
        <p>
          ...
          constructor or any other Turing machine. The universe of the Game of
          Life is an infinite, two-dimensional orthogonal grid of square cells,
          each of which is in one of two possible states, live or dead (or
          populated and unpopulated, respectively). Every cell interacts with
          its eight neighbors, which are the cells that are horizontally,
